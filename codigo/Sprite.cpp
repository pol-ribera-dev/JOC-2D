...
{
	float vertices[24] = {0.f, -quadSize.y, 0.f, 0.f,
												quadSize.x, -quadSize.y, sizeInSpritesheet.x, 0.f,
												quadSize.x, 0.f, sizeInSpritesheet.x, sizeInSpritesheet.y, 
												0.f, -quadSize.y, 0.f, 0.f,
												quadSize.x, 0.f, sizeInSpritesheet.x, sizeInSpritesheet.y, 
												0.f, 0.f, 0.f, sizeInSpritesheet.y};
